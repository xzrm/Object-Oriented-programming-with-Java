...
//        int sumDays1 = this.day + this.month * 30 + this.year * 365;
//        int sumDays2 = comparedDate.day + comparedDate.month * 30 + comparedDate.year * 365;
//        int difference = Math.abs(sumDays1 - sumDays2);
